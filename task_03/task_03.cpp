...
int main(void) {
  ...
  GLuint red_programID =
      LoadShaders("Transform.vertexshader", "RedFragmentShader.fragmentshader");

  GLuint blue_programID =
      LoadShaders("Transform.vertexshader", "BlueFragmentShader.fragmentshader");


  // Get a handle for our "MVP" uniform
  GLuint MatrixID_red = glGetUniformLocation(red_programID, "MVP");
  GLuint MatrixID_blue = glGetUniformLocation(blue_programID, "MVP");
  ...
  do {
    ...
    glm::mat4 View = glm::lookAt(
        glm::vec3(3*cos(alpha), 1, 3*sin(alpha)),  // Camera starts at (3,1,3), in World Space
  ...
  glDeleteProgram(blue_programID);
